...
// PN5180 EEPROM Addresses (named to avoid ambiguity)
...
#define TX_RFON_IRQ_STAT    	(1<<9)  // RF Field ON in PCD IRQN
...
public:
  ...
  //** CHANGED 2023-06-13 to allow including parameters to compile with ESP32
  void begin()    {
    begin(PN5180_NSS, PN5180_BUSY, PN5180_RST, PN5180_SPI);
  }
  void begin(uint8_t SSpin, uint8_t BUSYpin, uint8_t RSTpin, SPIClass& spi=SPI);         //NEW
  void end();
